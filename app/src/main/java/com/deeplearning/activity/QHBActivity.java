...
import com.deeplearning.job.WechatAccessbilityJob;
import com.deeplearning.util.BitmapUtils;

import java.io.File;
import com.deeplearning.R;
import com.deeplearning.config.Config;
import com.deeplearning.service.QiangHongBaoService;
import com.deeplearning.view.BaseSettingsFragment;
import com.deeplearning.application.QHBApplication;
 ...
 * 抢红包主界面
 */
public class QHBActivity extends BaseSettingsActivity {
    ...
    private void showAgreementDialog() {
        ...
        builder.setPositiveButton("同意", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                QHBApplication.eventStatistics(QHBActivity.this, "agreement", "true");
            }
        });
        builder.setNegativeButton("不同意", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                QHBApplication.eventStatistics(QHBActivity.this, "agreement", "false");
                finish();
            }
        });
        builder.show();
    ...
    private void showQrDialog() {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                QHBApplication.eventStatistics(QHBActivity.this, "copy_qr");
                dialog.dismiss();
            }
        });
        ...
        view.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                if(!output.exists()) {
                    ...
                    BitmapUtils.saveBitmap(QHBActivity.this, output, bitmap);
                }
                Toast.makeText(QHBActivity.this, "已保存到:" + output.getAbsolutePath(), Toast.LENGTH_LONG).show();
                return true;
            }
        });
        dialog.setContentView(view);
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            wechatPref.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                ...
                public boolean onPreferenceChange(Preference preference, Object newValue) {
                    if((Boolean) newValue && !QiangHongBaoService.isRunning()) {
                        ((QHBActivity)getActivity()).showOpenAccessibilityServiceDialog();
                    }
                    return true;
                }
            });
            ...
            notificationPref.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                ...
                public boolean onPreferenceChange(Preference preference, Object newValue) {
                    ...
                    if(enalbe && !QiangHongBaoService.isNotificationServiceRunning()) {
                        ((QHBActivity)getActivity()).openNotificationServiceSettings();
                        return false;
                    }
            ...
            if(preference != null) {
                preference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                    ...
                    public boolean onPreferenceClick(Preference preference) {
                        ((QHBActivity) getActivity()).showQrDialog();
            ...
            if(preference != null) {
                preference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                    @Override
                    public boolean onPreferenceClick(Preference preference) {
                        ((QHBActivity) getActivity()).showDonateDialog();
